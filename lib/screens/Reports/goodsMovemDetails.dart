...
class goodsMovDetails extends StatefulWidget {
  const goodsMovDetails({super.key});

  @override
  State<goodsMovDetails> createState() => _goodsMovDetailsState();
}

class _goodsMovDetailsState extends State<goodsMovDetails> {
