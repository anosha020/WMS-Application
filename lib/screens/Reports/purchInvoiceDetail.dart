...
class purchInvoiceDetail extends StatefulWidget {
  const purchInvoiceDetail({super.key});

  @override
  State<purchInvoiceDetail> createState() => _purchInvoiceDetailState();
}

class _purchInvoiceDetailState extends State<purchInvoiceDetail> {
