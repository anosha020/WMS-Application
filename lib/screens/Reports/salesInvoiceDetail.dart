...
class salesInvoDetail extends StatefulWidget {
  const salesInvoDetail({super.key});

  @override
  State<salesInvoDetail> createState() => _salesInvoDetailState();
}

class _salesInvoDetailState extends State<salesInvoDetail> {
