...
class invenQuarantine extends StatefulWidget {
  const invenQuarantine({super.key});

  @override
  State<invenQuarantine> createState() => _invenQuarantineState();
}

class _invenQuarantineState extends State<invenQuarantine> {
