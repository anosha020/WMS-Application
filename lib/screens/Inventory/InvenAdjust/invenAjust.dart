...
class invenAdjustment extends StatefulWidget {
  const invenAdjustment({super.key});

  @override
  State<invenAdjustment> createState() => _invenAdjustmentState();
}

class _invenAdjustmentState extends State<invenAdjustment> {
