...
class inTransferScreen extends StatefulWidget {
  const inTransferScreen({super.key});

  @override
  State<inTransferScreen> createState() => _inTransferScreenState();
}

class _inTransferScreenState extends State<inTransferScreen> {
